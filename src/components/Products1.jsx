...
export default function FeaturedProducts() {
  ...
  // Helper function to strip HTML tags and truncate text if too long.
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {Array.isArray(products) && products.length > 0 ? (
            products.map((product) => (
              <div
                key={product.id}
                className="bg-[#162033] shadow-2xl rounded-xl p-6 flex flex-col items-center border border-white/10"
              >
                ...
                <div className="mt-4 text-center">
                  ...
                  {product.sale_price && product.regular_price && product.regular_price !== product.sale_price && (
